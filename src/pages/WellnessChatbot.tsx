...
export const WellnessChatbot = () => {
  ...
  const handleQuestionResponse = async (response: string) => {
    ...
    try {
      ...
      // After AI responds, add appropriate follow-up as separate message
      if (questionPhase !== "question5") {
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            // Analyze user satisfaction to determine follow-up
            ...
            // Always send a separate follow-up message
            if (seemsUnsatisfied) {
  ...
  const handleChatMessage = async (message: string) => {
    ...
    if (waitingForFollowUp) {
      ...
      try {
        ...
        // Always add a separate "move on" prompt after follow-up response
        setTimeout(() => {
          setIsTyping(true);
          setTimeout(() => {
            setIsTyping(false);
